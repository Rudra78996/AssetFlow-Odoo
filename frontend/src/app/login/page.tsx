...
import { Package2, Mail, Lock, ArrowRight, ShieldCheck, BadgeCheck, Cloud, User, Info } from "lucide-react";
...
function LoginForm() {
  ...
  const handleSubmit = (ev: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      addToast({ message: mode === "login" ? "Welcome back!" : "Employee account created successfully!", type: "success" });
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-col w-1/2 bg-gradient-to-br from-primary to-primary/80 p-12 text-white relative overflow-hidden">
        ...
        <div className="flex-1 flex flex-col justify-center max-w-md">
          <h2 className="font-headline-lg text-headline-lg mb-6">Real-time asset intelligence for modern enterprises</h2>
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-body-md text-white/70">Track enterprise resources across global locations with sub-second latency and intelligent auditing.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-body-md text-white/70">Utilize ML-driven insights to schedule maintenance before hardware failure occurs.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          {mode === "login" ? (
            <>
              ...
              <p className="text-body-md text-on-surface-variant mb-8">Enter your credentials to access your dashboard.</p>
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <button type="button" className="text-label-md text-primary hover:underline">Forgot password?</button>
                  </div>
                  <div className="relative">
            ...
            <>
              ...
              <p className="text-body-md text-on-surface-variant mb-6">Join your organization&apos;s AssetFlow network.</p>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-start gap-2 p-3 bg-secondary-container/30 rounded-md">
                  ...
                  <p className="text-label-md text-secondary leading-normal">
                    Registration is restricted to <span className="font-bold">Employee</span> access. Administrative privileges must be granted by your IT Director after verification.
                  </p>
                </div>
                <button type="submit" disabled={loading} className="btn-primary w-full justify-center py-3 disabled:opacity-60">
