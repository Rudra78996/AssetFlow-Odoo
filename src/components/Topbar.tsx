        ...
        <div className="relative" ref={profileRef}>
          ...
          {showProfile && (
            <div className="absolute right-0 top-full mt-2 w-56 bg-surface-container-lowest border border-outline-variant rounded-lg shadow-ambient z-50">
              ...
              <div className="p-2">
                <a href="/settings" className="block w-full text-left px-3 py-2 rounded-md hover:bg-surface-container-low text-body-md">
                  Profile Settings
                </a>
                <a href="/support" className="block w-full text-left px-3 py-2 rounded-md hover:bg-surface-container-low text-body-md">
                  Support
                </a>
                <button
                  onClick={handleSignOut}
                  className="w-full text-left px-3 py-2 rounded-md hover:bg-surface-container-low text-body-md text-error"
                >
                  Sign Out
                </button>
              </div>
